...
# Benchmarking with NVIDIA TensorRT-LLM

Jan now supports NVIDIA TensorRT-LLM in addition to llama.cpp, which is available in Release [v0.4.9+](https://github.com/janhq/jan/releases/tag/v0.4.9). 
...
<Callout type="info" >
  Bugs or feedback? Let us know on [GitHub](https://github.com/janhq/jan) or via [Discord #tensorrt-llm channel](https://discord.com/channels/1107178041848909847/1201832734704795688).
</Callout>


## Why NVIDIA TensorRT-LLM?
...
### Hardware Selection
We chose the following NVIDIA GPUs based on our users' preferences:
...
| Laptop Intel i7 13800H CPU | (Not supported) | ✅ 11.57t/s |     |
