...
The following sections detail the error categories, their descriptions, and the specific codes.
<Callout type="info">
...
These errors relate to issues encountered during installation, encompassing both desktop and server setups.
- Prefix: INST
...
| Error Code | Cause                          | Solution                                                                                    |
|------------|---------------------------------------------|---------------------------------------------------------------------------------------------------------------|
| IE-2       | OpenAI model's API key is invalid.          | [How to Integrate OpenAI API](/docs/remote-inference/openai#how-to-integrate-openai-api-with-jan) |
| IE-3       | Groq model's API key is invalid.             | [How to Integrate Groq API](/docs/remote-inference/groq#how-to-integrate-groq-api-with-jan)      |
| IE-4       | Mistral model's API key is invalid.          | [How to Integrate Mistral API](/docs/remote-inference/mistralai)                                 |
| IE-5       | OpenRouter model's API key is invalid.       | [How to Integrate OpenRouter API](/docs/remote-inference/openrouter)                                 |
