...
<Callout type='info' emoji=''>
  - The Groq Inference Engine is the default extension for the Jan application. All Groq models should be installed automatically when you install the Jan application.
</Callout>
