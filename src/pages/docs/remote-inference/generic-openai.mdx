...
3. Configure `full_url` properties with the endpoint server you want to connect. For example, if you're going to communicate to Jan's API server, you can configure it as follows:

```json ~jan/settings/@janhq/inference-openai-extension/settings.json
{
