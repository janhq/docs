...
Jan is a ChatGPT-alternative that runs 100% offline on your [Desktop](/docs/desktop-installation) (or [Server](/docs/server-installation)). Our goal is to make it easy for a layperson to download and run LLMs, and use AI with full control and [privacy](https://www.reuters.com/legal/legalindustry/privacy-paradox-with-ai-2023-10-31/) [^1].
