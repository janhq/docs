...
- **[Extensions](https://jan.aidocs/extensions):** Expand Jan's capabilities with multi-inferences and specific settings for each extension.
- **[Integration](https://jan.aidocs/integrations):** Integrate Jan with key tools and platforms to enhance your development environment.
