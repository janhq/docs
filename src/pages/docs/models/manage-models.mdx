...
<br/>
#### 3. Download with Jan Deeplink
Follow these steps to download a specific model from [Hugging Face](https://huggingface.co/models) using Jan's deep link feature. The deep link format is: `jan://models/huggingface/<model's ID>`.
<Callout type="warning">
