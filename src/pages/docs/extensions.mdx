...
| Inference Engine Nitro Extension   | `v1.0.0`  | This extension embeds Nitro, a lightweight (3 MB) inference engine in C++. See nitro.jan.ai.               | [Source](https://github.com/janhq/jan/tree/dev/extensions/inference-nitro-extension)         |
...
| Inference Engine Tensor RT Llm Extension | `v.0.0.3`  | This extension enables Nvidia's TensorRT-LLM for the fastest GPU acceleration.                                | [Source](https://github.com/janhq/jan/tree/dev/extensions/tensorrt-llm-extension) |
...
Jan offers an Extensions settings menu for configuring extensions that have registered their own settings within the application. Here, you can directly integrate Remote Inference Engines with Jan, without have to insert the URL and API Key directly in the `JSON` file. Additionally, you can enable or disable Logging extensions available in Jan. To access the Extension settings, follow the steps below:
...
4. Use the **slider** to enable or disable the app logging feature.
