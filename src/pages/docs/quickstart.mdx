...
After downloading and configuring your model, you can start chatting with the model.
...
### Step 5: Customize the Assistant Instruction
Tailor the assistant's behavior to your preferences by providing specific instructions:
...
![Assistant](./_assets/asst-instructions.gif)
...
1. Explore the wide range of [extensions](/docs/extensions) available to enhance your experience.
