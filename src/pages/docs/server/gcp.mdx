...
<Callout type="info">
You can utilize a remote data folder for the autoscaling feature. Refer to the [Advanced Use](/docs/server/gcp#advanced-use) section for more details.
</Callout>
<Steps>
### Step 1: Customize the Docker Engine and Compose
1. Set up the docker profile and environment variables.
<Callout type="info">
Please see the [Understanding Jan's Dockerfile](/docs/server/gcp#understanding-the-jans-dockerfiles) section below for details on the docker file.
</Callout>
