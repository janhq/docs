...
<Callout>
We're named after the [Homebrew Computer Club](https://en.wikipedia.org/wiki/Homebrew_Computer_Club), an early computer hobbyist group in the 70s and 80s that led to the personal computer revolution.
</Callout>
