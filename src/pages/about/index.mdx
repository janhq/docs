...
We're a team of AI researchers and engineers inspired by [The Homebrew Computer Club](https://en.wikipedia.org/wiki/Homebrew_Computer_Club), to which we owe today's computers and hardware. We are the creators and lead maintainers of a few open-source AI tools: 
...
Homebrew Computer Company is an opinionated company with a clear philosophy for the products we build: 
