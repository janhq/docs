...
<Tabs items={['Motherboard', 'CPU', 'GPU', 'Memory', 'HDD', 'SSD', 'PSU']}>
  <Tabs.Tab>
    ...
    | *[Source](https://www.techspot.com/article/1965-anatomy-motherboard/)* |
  ...
  <Tabs.Tab>
    ...
    | *[Source](https://www.techspot.com/article/2024-anatomy-ram/)* |
  ...
  <Tabs.Tab>
    ...
    | *[Source](https://www.techspot.com/article/1985-anatomy-ssd/)* |
  ...
  <Tabs.Tab>
    # PSU
    | *[Source](https://www.techspot.com/article/1967-anatomy-psu/)* |

    ![image](../_assets/anatomy-psu-3.png)
    | *What is inside a PSU* |

    | Consumer PSU | Server grade PSU
    |--|--|
    | ![image](../_assets/anatomy-psu-1.png) | ![image](../_assets/anatomy-psu-2.png) |
