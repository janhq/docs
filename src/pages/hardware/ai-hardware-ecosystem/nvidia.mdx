...
## Why A.I computer needs NVIDIA GPU
https://www.youtube.com/watch?v=-P28LKWTzrI&t=91s
| *Video to illustrate why GPU with parallel processing is important to A.I versus. CPU with sequential tasks* |

## NVIDIA Ecosystem for hardware and software
![image](../_assets/ecosystem-nvidia.drawio.svg)
| *NVIDIA Ecosystem preview* |
