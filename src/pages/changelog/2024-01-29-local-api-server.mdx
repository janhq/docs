...
- Local API Server: Experience the Jan's dashboard for local API server to make your data processing smoother and more efficient.
- HTTP Proxy Support: Now, downloading and connecting are seamless, just like browsing Hugging Face in your browser.
- Updated Settings Page: Find what you need, faster! We've updated settings page.
