...
Additionally, 'Command R+' is now supported, marking it as the first open-source model to surpass GPT-4 on the [LMSys leaderboard](https://chat.lmsys.org/?leaderboard).
