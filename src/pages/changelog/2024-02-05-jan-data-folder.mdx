...
- `Changing Jan Data Folder`: Now, moving your data across different folders is just a click away, making organization simpler. So you can use even an external drive.
- Factory Settings: You can reset all Jan's usage data for a fresh start.
