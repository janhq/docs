...
- **NVIDIA GPU with CUDA Toolkit 11.7 or higher**: Necessary for utilizing NVIDIA GPUs in GPU mode.
- **CPU Instruction Sets**: Available for download from the [Cortex GitHub Releases](https://github.com/janhq/cortex/releases) page.

<Callout type="info">
The **CUDA Toolkit** and **CPU instruction sets** are not required for the initial installation of Cortex. These dependencies will be automatically installed during the Cortex initialization if they are not already on your system.
...
To install Cortex in Linux, follow the steps below:
<Steps>
