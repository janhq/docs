...
```bash
# Streaming
cortex chat "hello world"

## Not streaming
cortex chat "hello world" --stream false
```
</Tabs.Tab>
</Tabs>
...
Cortex enables developers to seamlessly scale their applications from prototype to production, supporting diverse hardware configurations: CPU-only laptops with Llama.cpp and GPU-accelerated clusters with TensorRT-LLM. Depending on the hardware and models used during runtime, Cortex defaults to the appropriate engine. 
