...
Models can be downloaded using a Docker-like interface with the following syntax: `model_name:variant_tag`. Each variant may include different quantizations and sizes, typically organized in the repository’s branches.
